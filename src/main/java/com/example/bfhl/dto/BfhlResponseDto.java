...
public class BfhlResponseDto {
    ...
    // Note: Agar unke format me "special_characters" hai toh ise aise hi rehne do. 
    // Agar example B wala typo unhone compulsory rakha hai, toh niche "sepcial_characters" kar dena.
    ...
    // Getters and Setters
    // Jackson glitch ko fix karne ke liye custom getter name use kiya hai
    @JsonProperty("is_success")
